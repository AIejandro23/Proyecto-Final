 ...
 * @author Alejandro
 */
@WebServlet(name = "Menorca", urlPatterns = {"/Menorca"})
public class Menorca extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       List<Car> coches = crud.consultaVehiculo(3, 0);
       
          RequestDispatcher rs = request.getRequestDispatcher("/WEB-INF/Layout.jsp");
                  httpsession.setAttribute("listaVehiculos",coches);
                  httpsession.setAttribute("fechaRecogida",null);
